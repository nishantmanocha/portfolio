...
const LINES = ["$ cd portfolio", "$ code ."]; // lines to type
	...
	return (
		...
		>
			<div className="w-full max-w-2xl px-6">
				<div className="rounded-lg border border-neutral-800 bg-neutral-950/80 p-6 shadow-2xl">
					<div className="mb-4 text-neutral-400 text-sm">terminal</div>
